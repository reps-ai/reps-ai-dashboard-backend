...
async def qualify_lead(
    id: str = Path(..., description="The ID of the lead to qualify"),
...
async def add_tags_to_lead(
    id: str = Path(..., description="The ID of the lead to add tags to"),
    tags: List[str] = Body(..., description="List of tags to add"),
    lead_service: DefaultLeadService = Depends(get_lead_service)
):
    """Add tags to a lead."""
